...
if (!process.env.CLIENT_URL) {
  if (process.env.NODE_ENV === 'production') {
    ...
    process.env.CLIENT_URL = process.env.FRONTEND_URL || 'https://multimedia-university-fellowship.vercel.app';
  } else {
...
// CORS configuration
app.use(cors({
  origin: process.env.CLIENT_URL || 'https://multimedia-university-fellowship.vercel.app',
  credentials: true 
}));
